...
<div class="form-group well">
    ...
    <div class="row">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="military_rank" name="military_rank" value="{{ old('military_rank', $user->military_rank ?? '') }}"
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="service_name" name="service_name" value="{{ old('service_name', $user->service_name ?? '') }}"
    ...
    <div class="row">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="military_unit" name="military_unit" value="{{ old('military_unit', $user->military_unit ?? '') }}"
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control masked-cel-phone" id="phone" name="phone" value="{{ old('phone', $user->phone ?? '') }}"
